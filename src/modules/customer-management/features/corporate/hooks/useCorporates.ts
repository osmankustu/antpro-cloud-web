...
export function useCorporates(pageSize: number = 10) {
  ...
  const {
    ...
    ? useGetCorporateCustomersByDynamicQuery({ ...queryArgs, query: dynamicQuery })
    : useGetCorporateCustomersQuery(queryArgs);
