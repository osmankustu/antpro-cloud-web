...
interface CorporateDetailPageProps {
...
export default function CorporateDetailPage({
  ...
  if (!customer) {
    return <div className="text-center text-gray-500 dark:text-gray-400">Müşteri bulunamadı.</div>;
  }
  ...
  return (
    <div className="space-y-8">
      ...
      <Section title="Genel Bilgiler">
        <Row>
          <Field label="Firma Adı" value={customer.companyName || '-'} />
          <Field label="Müşteri Numarası" value={customer.customerNo} />
          <Field label="Müşteri Tipi" value={'Kurumsal'} />
        </Row>
        <Row>
          <Field label="Vergi Dairesi" value={'-'} />
          <Field label="Vergi Numarası" value={customer.taxNumber} />
          <Field label="Firma Sektörü" value={customer.sector || '-'} />
        </Row>
        <Row>
      ...
      <Section title="Yetkili İletişim Bilgileri">
        <Row>
          <Field label="Adı-Soyadı" value={customer.authorizedPerson} />
          <Field label="Email" value={customer.authorizedPersonEmail} />
          <Field label="Telefon" value={customer.authorizedPersonPhone} />
        </Row>
      </Section>
