...
export function IndividudalDetailToolbar({
  customer,
  isLoading,
  isFetching,
  router,
        ...
        <div className="scrollbar-none overflow-x-auto">
          <div className="flex min-w-max gap-2">
            <ToolbarButton
              ...
              onClick={() =>
                router.push(`/management/customer-management/individual/${customer?.id}`)
              }
            >
              Genel Bilgiler
            </ToolbarButton>
            ...
            <ToolbarButton
              ...
              onClick={() =>
                router.push(
                  `/management/customer-management/individual/${customer?.id}/service-history`,
                )
              }
            >
              Servis Geçmişi
            ...
            <ToolbarButton
              active={isEdit}
              onClick={() =>
                router.push(`/management/customer-management/individual/${customer?.id}/edit`)
              }
            >
              Düzenle
            </ToolbarButton>
