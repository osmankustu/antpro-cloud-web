...
import { ServiceHistoryModel } from '@/modules/customer-management/types/serviceHistory.type';
...
export function ServiceHistoryMobileList({
  services,
  isLoading,
  isFetching,
  error,
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-2 text-xs text-gray-500 dark:text-gray-400">
              <div>
                ...
                <PriorityStatus priority={service.priority} size="md" />
              </div>
