...
const navItems: NavItem[] = [
  ...
  },
  {
    ...
    subItems: [
      { name: 'Servis Oluştur', path: '/management/service-management/add-service' },
  ...
  },
  {
    ...
    subItems: [
      { name: 'Müşteri Oluştur', path: '/management/customer-management/add-customer' },
      { name: 'Kurumsal', path: '/management/customer-management/corporate' },
      { name: 'Bireysel', path: '/management/customer-management/individual' },
    ],
  },
        ...
        <nav className="mb-6">
          <div className="flex flex-col gap-4">
            <div>
              ...
              >
                {isExpanded || isHovered || isMobileOpen ? 'Menu' : <HiDotsHorizontal />}
              </h2>
            ...
            <div className="">
              ...
              >
                {isExpanded || isHovered || isMobileOpen ? 'Others' : <HiDotsHorizontal />}
              </h2>
